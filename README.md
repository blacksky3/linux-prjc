...
Linux kernel build for Archlinux with PDS/BMQ CPU scheduler patch by Alfred Chen, Piotr Górski Arch, Block and CPU patches and Graysky2 kernel_compiler_patch patch.
