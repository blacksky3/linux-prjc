...
Linux kernel build for Archlinux with Alfred Chen PDS/BMQ CPU scheduler (kept alive artificially by Piotr Górski), Arch, Block, CPU, CPU Power, Futex, PRJC Fixes and kernel_compiler_patch patch.
